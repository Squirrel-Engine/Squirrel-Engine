...
namespace Assimp
{
    ...
    // ------------------------------------------------------------------------------------
    inline
    unsigned int strtoul10(const char* in, const char** out = nullptr)
    {
    ...
    // ------------------------------------------------------------------------------------
    inline
    unsigned int strtoul8(const char* in, const char** out = nullptr)
    {
        unsigned int value(0);
        for (;;)
        {
    ...
    // ------------------------------------------------------------------------------------
    inline
    unsigned int strtoul16(const char* in, const char** out = nullptr)
    {
        unsigned int value(0);
        for (;;)
        {
    ...
    {
        return (static_cast<uint8_t>(HexDigitToDecimal(in[0])) << 4) + static_cast<uint8_t>(HexDigitToDecimal(in[1]));
    }
    ...
    // ------------------------------------------------------------------------------------
    inline
    int strtol10(const char* in, const char** out = nullptr)
    {
        bool inv = (*in == '-');
        if (inv || *in == '+')
        {
    ...
    // ------------------------------------------------------------------------------------
    inline
    unsigned int strtoul_cppstyle(const char* in, const char** out = nullptr)
    {
        if ('0' == in[0])
        {
    ...
    // ------------------------------------------------------------------------------------
    inline
    uint64_t strtoul10_64(const char* in, const char** out = nullptr, unsigned int* max_inout = nullptr)
    {
        unsigned int cur = 0;
        uint64_t value = 0;
        ...
        for (;;)
        {
            ...
            const uint64_t new_value = (value * static_cast<uint64_t>(10)) + static_cast<uint64_t>(*in - '0');
    ...
    // ------------------------------------------------------------------------------------
    inline
    int64_t strtol10_64(const char* in, const char** out = nullptr, unsigned int* max_inout = nullptr)
    {
        bool inv = (*in == '-');
        if (inv || *in == '+')
        {

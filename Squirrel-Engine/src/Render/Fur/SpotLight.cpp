...
SpotLight::SpotLight(glm::vec3& pos, glm::vec3& dir)
	: LightObject(1.0f, glm::vec3(100.00f, 100.00f, 100.00f)), m_AttenuationRadius(50.0f), m_Position(pos), m_Direction(dir), m_CutOff(glm::cos(glm::radians(12.5f))), m_OuterCutOff(glm::cos(glm::radians(15.0f))) {}

...
SpotLight::SpotLight(glm::vec3& pos, glm::vec3& dir)
	: LightObject(10.0f, glm::vec3(255.0, 255.0, 255.0)), m_AttenuationRadius(125.0f), m_Position(pos), m_Direction(dir), m_CutOff(glm::cos(glm::radians(30.5f))), m_OuterCutOff(glm::cos(glm::radians(36.0f))) {}
